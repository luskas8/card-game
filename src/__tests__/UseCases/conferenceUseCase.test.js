...
describe("conferenceUseCase", () => {
    beforeEach((done) => {
        ...
        Game._players = [new Player("TESTADOR", "123", { isHost: true, isTheKiller: true, wasTheKiller: true, character: "Serena", killerScore: 4, baseScore: 3 }), new Player("TESTADOR", "1234", { character: "Zeca" }), new Player("TESTADOR", "1235", { character: "Zeca" }), new Player("TESTADOR", "12356", { character: "Zeca" }), new Player("TESTADOR", "1236", { character: "Zeca" })]
        Game._playersNotWasKillerSocketID = ["123","1234", "1235", "1236", "12356"]
        done()
    })
